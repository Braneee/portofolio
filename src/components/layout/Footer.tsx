        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2.5 font-sans text-lg font-bold text-text-primary tracking-tight group">
              <span className="flex h-7 w-7 items-center justify-center rounded-lg overflow-hidden bg-black shadow-md shadow-primary-500/10 group-hover:scale-105 transition-transform duration-200">
